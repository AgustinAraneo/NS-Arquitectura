    ...
    return (
        <div>
            <div className='w-full  text-black bg-white font-Montserrat'>
                ...
                <p className='mx-auto text-xl font-Montserrat pt-4 w-[68%] leading-8 text-justify'>Somos un estudio de arquitectura y construcción
            ...
            <div className='flex text-black text-3xl justify-center grid-cols-3 pt-16 w-[70%] leading-8 mx-auto pb-16 font-Montserrat'>
                <div className='w-[50%] mx-auto'>
                    ...
                    <p className='pt-4 text-[17px] w-[90%] mx-auto text-justify'>Nuestro equipo está altamente calificado y cuentan con años de experiencia en la industria. Nos mantenemos actualizados con las últimas tendencias y tecnologías en el campo de la arquitectura y la construcción, para ofrecer soluciones innovadoras y eficientes.</p>
                </div>
                <div className='w-[50%] mx-auto'>
                    <FaHardHat className='mx-auto' />
                    <p className='pt-4 mx-auto font-medium text-center'>Confianza</p>
                    <p className='pt-4 text-[17px] w-[90%] mx-auto text-justify'>Confía en nosotros para hacer realidad tu proyecto. Desde el inicio hasta el final, te guiaremos de manera profesional y cercana para asegurarnos de que tu visión se convierta en realidad.</p>
                </div>
                <div className='w-[50%] mx-auto'>
                    <GrZoomIn className='mx-auto' />
                    <p className='pt-4 mx-auto font-medium text-center'>Responsabilidad</p>
                    <p className='pt-4 text-[17px]  w-[90%] mx-auto text-justify'>Estamos comprometidos en proporcionar una experiencia de construcción transparente y sin complicaciones para nuestros clientes. Trabajamos con los más altos estándares de calidad, eficiencia y atención al detalle, para que tu proyecto sea entregado a tiempo y en condiciones.</p>
                </div>
            </div>
